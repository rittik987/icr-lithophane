...
export default function CartPage() {
  ...
  const { items, totalCount, subtotal, isLoaded, updateQty, remove, clear } =
    useCart();

  const [promoInput, setPromoInput] = useState("");
  const [appliedPromo, setAppliedPromo] = useState<CouponValidation | null>(
    null
  );
  const [promoError, setPromoError] = useState("");
  const [promoLoading, setPromoLoading] = useState(false);
  const [isCouponDrawerOpen, setIsCouponDrawerOpen] = useState(false);
  const [availableCouponsCount, setAvailableCouponsCount] = useState<
    number | null
  >(null);
  ...
  const discountAmount = appliedPromo
    ? appliedPromo.discountAmount / 100
    : 0;
  ...
  return (
    <div className="min-h-screen bg-[#faf7f2] text-[#2e1e12] flex flex-col">
        ...
        {items.length === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center max-w-md mx-auto">
            ...
            <p className="text-[#6e5c50] text-sm font-sans mb-8 leading-relaxed">
              You haven’t created a personalised lithophane yet. Choose any
              photo you love and turn it into something personal to gift or
              keep.
            </p>

            <Link
              href="/customize"
              className="bg-[#e07a28] hover:bg-[#c96a1f] text-white font-bold font-sans text-sm uppercase tracking-wider px-8 py-3.5 rounded-sm shadow-[0_4px_14px_rgba(224,122,40,0.35)] transition-all active:scale-[0.98]"
            >
          ...
          <div className="mt-4">
            {/* Shipping Banner */}
            <div className="bg-[#eaf5ec] border border-[#c6e6ca] rounded-sm px-4 py-2.5 mb-6 flex items-center gap-2.5 text-xs text-[#1e7234] font-medium font-sans">
              <svg
                width="16"
                height="16"
                viewBox="0 0 20 20"
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="shrink-0 text-[#1e7234]"
              >
              ...
              <span>
                <strong>Free Shipping on Prepaid Orders</strong> · Delivery in
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-8 items-start">
              ...
              <div className="flex flex-col gap-4">
                {items.map((item) => {
                  ...
                  return (
                    <div
                      key={item.id}
                      className="bg-white border border-[#e5ddd0] rounded-sm p-4 sm:p-5 shadow-sm transition-all hover:shadow-md"
                    >
                      ...
                      <div className="flex gap-3.5 sm:gap-4 items-start">
                        ...
                        <div
                          ...
                          className="relative w-20 h-20 sm:w-28 sm:h-28 rounded-sm overflow-hidden border border-[#e5ddd0] bg-[#fffdf8] shrink-0 cursor-zoom-in group shadow-inner"
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-start justify-between gap-2">
                            <span className="inline-block bg-[#f2ebdc] text-[#5a3a1a] text-[10px] font-bold tracking-wider uppercase px-2 py-0.5 rounded-sm">
                              {item.templateName}
                            </span>
                            ...
                            <button
                              ...
                              className="text-[#8c786a] hover:text-[#b83a3a] p-1 rounded-sm hover:bg-[#faf7f2] transition-colors shrink-0"
                            >
                              <svg
                                width="17"
                                height="17"
                              ...
                              >
                                <path
                                  d="M4 6h12M8 6V4a1 1 0 011-1h2a1 1 0 011 1v2m3 0v11a2 2 0 01-2 2H7a2 2 0 01-2-2V6h10z"
                                  stroke="currentColor"
                                  strokeWidth="1.6"
                                  strokeLinecap="round"
                                  strokeLinejoin="round"
                          ...
                          <p className="text-xs text-[#6e5c50] font-sans mt-0.5">
                            20 × 15 × 4 cm · Wooden Frame · Warm LED
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between mt-3 pt-3 border-t border-[#f2ebdc]">
                        {/* Quantity Controls */}
                        <div className="flex items-center border border-[#e5ddd0] rounded-sm bg-[#faf7f2] overflow-hidden shadow-xs">
                          <button
                        ...
                        <div className="mt-3 pt-3 border-t border-[#f0e8dc]">
                          ...
                          >
                            <span className="flex items-center gap-1.5 font-sans">
                              <span>
                                Customization details ({photoList.length}{" "}
                                {photoList.length === 1
                                  ? "photo"
                                  : "photos"}
                                {textList.length > 0
                          ...
                          {isExpanded && (
                            <div className="mt-3 bg-[#faf7f2] rounded-sm p-3 text-xs font-sans flex flex-col gap-3 border border-[#f0e8dc]">
                              {/* Photos list */}
                              {photoList.length > 0 && (
                                <div>
                                  ...
                                  <div className="grid grid-cols-3 gap-2">
                                    {photoList.map((photo) => (
                                      ...
                                      >
                                        <div className="relative w-full aspect-square rounded-sm overflow-hidden border border-[#e5ddd0] bg-white">
                                          <Image
                                            src={photo.dataUrl}
                                            alt={photo.slotLabel}
                                            fill
                                  ...
                                  <ul className="flex flex-col gap-1 text-[11px] text-[#2e1e12]">
                                    {textList.map((txt) => (
                                      ...
                                      >
                                        ...
                                        <span className="font-medium italic text-right">
                                          &ldquo;{txt.value}&rdquo;
                                        </span>
                                      </li>
                                    ))}
                                  </ul>
                ...
                <Link
                  href="/customize"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 border border-dashed border-[#e07a28]/60 hover:border-[#e07a28] bg-white hover:bg-[#fdfbf7] text-xs font-bold font-sans text-[#e07a28] px-4 py-2.5 rounded-sm transition-all shadow-2xs mt-1"
                >
                  <svg
                    width="14"
                    height="14"
                ...
                {/* ── Offers & Coupons Card ───────────────────────────── */}
                <section
                  aria-label="Available offers and coupons"
                  className="mt-2.5"
                >
                  {!appliedPromo ? (
                    <div
                      onClick={() => setIsCouponDrawerOpen(true)}
                      className="bg-white border border-[#e5ddd0] hover:border-[#e07a28]/60 active:bg-[#fbf7f0] rounded-sm p-3.5 sm:p-4 flex items-center justify-between gap-3 shadow-2xs hover:shadow-xs transition-all cursor-pointer group"
                    >
                      <div className="flex items-center gap-2.5 sm:gap-3 flex-1 min-w-0">
                        <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-sm bg-[#fdf2e8] text-[#e07a28] flex items-center justify-center shrink-0 border border-[#f5dbca]">
                          <svg
                            width="18"
                            height="18"
                            viewBox="0 0 24 24"
                          ...
                          <div className="flex items-center gap-1.5 flex-wrap">
                            ...
                            {availableCouponsCount !== null &&
                              availableCouponsCount > 0 && (
                                <span className="text-[10px] font-bold px-1.5 py-0.5 rounded-sm bg-[#fdf0e6] text-[#e07a28] border border-[#f8dec8] leading-none shrink-0">
                                  {availableCouponsCount} available
                                </span>
                              )}
                          </div>

                          <p className="text-[11px] text-[#6e5c50] font-sans mt-0.5 leading-tight">
                            Tap to view &amp; apply discount codes
                          </p>
                        </div>
                      </div>
                      ...
                      <button
                        ...
                        className="flex items-center gap-1 text-xs font-bold text-[#e07a28] group-hover:translate-x-0.5 transition-transform shrink-0 font-sans cursor-pointer whitespace-nowrap px-2.5 py-1 rounded-sm border border-[#e07a28]/30 bg-[#fffdfa]"
                      >
                        <span>View</span>
                    ...
                    <div className="bg-[#f0f9f2] border border-[#bfe5c6] rounded-sm p-3.5 sm:p-4 flex items-center justify-between gap-2.5 shadow-2xs animate-fadeIn">
                      <div className="flex items-center gap-2.5 sm:gap-3 flex-1 min-w-0">
                        <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-sm bg-[#e0f3e4] text-[#1e7234] flex items-center justify-center shrink-0 border border-[#bfe5c6]">
                          <svg
                            width="18"
                            height="18"
                            viewBox="0 0 24 24"
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        ...
                        <button
                          ...
                          className="text-xs font-bold text-[#b83a3a] hover:bg-[#fdeeee] px-2 py-1 rounded-sm border border-[#f5c6cb] transition-colors font-sans cursor-pointer"
                        >
                          Remove
                        </button>
                      </div>
                ...
                {/* ── Mobile Bill Details ───────────────────────────── */}
                <div className="lg:hidden bg-white border border-[#e5ddd0] rounded-sm p-4 sm:p-5 shadow-2xs flex flex-col gap-3 mt-2.5">
                  ...
                  <div className="flex flex-col gap-2.5 text-xs font-sans text-[#6e5c50]">
                    ...
                    {discountAmount > 0 && (
                      <div className="flex justify-between items-center text-[#1e7234]">
                        <span>
                          Coupon Discount ({appliedPromo?.coupon.code})
                        </span>
                    ...
                    <div className="flex justify-between items-center">
                      <span>Personalised Design &amp; Warm LED</span>

                      <span className="text-[#1e7234] font-semibold uppercase text-[11px]">
                        FREE
                      </span>
                    </div>
              ...
              <div className="hidden lg:flex flex-col gap-4 sticky top-24">
                <div className="bg-white border border-[#e5ddd0] rounded-sm p-5 lg:p-6 shadow-sm">
                  ...
                  <div className="mb-4">
                    ...
                    {appliedPromo ? (
                      <div className="flex items-center justify-between bg-[#eaf5ec] border border-[#c6e6ca] rounded-sm px-3 py-2.5 text-xs text-[#1e7234] font-sans">
                        <div>
                          <span className="font-semibold block">
                            ✓ {appliedPromo.coupon.code} applied
                          </span>

                          <span className="text-[11px] text-[#2e6e3c]">
                            Saving ₹
                            {(
                              appliedPromo.discountAmount / 100
                            ).toLocaleString("en-IN")}
                      ...
                      <button
                        type="button"
                        onClick={() => setIsCouponDrawerOpen(true)}
                        className="w-full bg-[#fdfbf7] hover:bg-[#fbf4ea] border border-dashed border-[#e07a28]/60 hover:border-[#e07a28] rounded-sm px-3 py-2.5 text-left flex items-center justify-between transition-colors group cursor-pointer"
                      >
                  ...
                  <div className="flex flex-col gap-2.5 text-sm font-sans border-t border-[#f2ebdc] pt-4">
                    ...
                    {discountAmount > 0 && (
                      <div className="flex justify-between text-[#1e7234]">
                        <span>
                          Discount ({appliedPromo?.coupon.code})
                        </span>
                    ...
                    <div className="flex justify-between text-[#6e5c50]">
                      ...
                      <span className="text-[#1e7234] font-semibold uppercase text-xs">
                        FREE
                      </span>
                    </div>
                    ...
                    <div className="border-t border-[#e5ddd0] pt-3 mt-1 flex justify-between items-baseline">
                      <span className="text-base font-bold text-[#2e1e12]">
                        Total Amount
                      </span>
                  ...
                  <button
                    onClick={() =>
                      router.push(
                        `/checkout${
                          appliedPromo
                            ? `?coupon=${appliedPromo.coupon.code}`
                            : ""
                        }`
                      )
                    }
                    className="w-full mt-6 bg-[#e07a28] hover:bg-[#c96a1f] text-white font-bold font-sans text-sm uppercase tracking-wider py-4 rounded-sm shadow-[0_4px_14px_rgba(224,122,40,0.35)] transition-all active:scale-[0.98] flex items-center justify-center gap-2 group"
                  >
                  ...
                  <div className="mt-5 pt-4 border-t border-[#f2ebdc] flex flex-col gap-2.5 text-[11px] text-[#6e5c50] font-sans">
                    <div className="flex items-center gap-2">
                      <svg
                        ...
                        viewBox="0 0 16 16"
                        fill="none"
                        className="text-[#e07a28] shrink-0"
                      >
                        <path
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      >
                        <path
                          d="M8 1.5l6 2.5v4.5c0 4-2.5 6.5-6 7.5-3.5-1-6-3.5-6-7.5V4l6-2.5z"
                          stroke="currentColor"
                          strokeWidth="1.5"
                        />
                      </svg>

                      <span>Replacement for Eligible Issues</span>
                    </div>
      ...
      {selectedPreviewItem && (
        ...
        >
          <div
            className="bg-[#faf7f2] rounded-sm max-w-xl w-full overflow-hidden shadow-2xl flex flex-col max-h-[90vh]"
          ...
          >
            <div className="flex items-center justify-between px-5 py-4 border-b border-[#e5ddd0]">
              ...
              <button
                onClick={() => setSelectedPreviewItem(null)}
                className="w-8 h-8 rounded-sm hover:bg-[#ede5d6] flex items-center justify-center text-[#2e1e12]"
              >
                ✕
              </button>
            </div>
            ...
            <div className="p-4 overflow-y-auto flex items-center justify-center bg-[#fffdf8]">
              {selectedPreviewItem.previewDataUrl && (
                <Image
                  ...
                  width={600}
                  height={600}
                  className="max-h-[60vh] w-auto object-contain rounded-sm border border-[#e5ddd0] shadow-md"
                  unoptimized
                />
              )}
            </div>
            ...
            <div className="p-4 border-t border-[#e5ddd0] flex justify-end">
              <button
                onClick={() => setSelectedPreviewItem(null)}
                className="bg-[#2e1e12] text-white px-5 py-2.5 rounded-sm font-sans text-xs font-bold uppercase tracking-wider"
              >
                Close
              </button>
            </div>
        ...
        >
          <div className="flex items-center justify-between gap-4 max-w-lg mx-auto">
            ...
            <button
              ...
              className="bg-[#e07a28] hover:bg-[#c96a1f] text-white font-bold font-sans text-xs uppercase tracking-wider px-7 py-3.5 rounded-sm shadow-md transition-all active:scale-[0.98] flex items-center gap-2 shrink-0 cursor-pointer"
            >
              <span>Checkout</span>
